...
from PyQt5.QtWidgets import QInputDialog, QLineEdit, QApplication, QMainWindow, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QSlider, QLabel, QFileDialog
import app
...
class Ui_MainWindow(object):
    ...
    def load_image(self):
        ...
        try:
            ...
            pixelList, rayList = app.preliminar_calculations(sceneObjects[LIST_CAM], sceneObjects[LIST_IMG], sceneObjects)
        
            for pixel in pixelList:
                self.pixelList.append([int(pixel.red), int(pixel.green), int(pixel.blue)])
